...
@interface PullableView : UIView {
    ...
    CGPoint startPos;
    CGPoint minVisiblePoint;
    CGPoint maxVisiblePoint;
    ...
    id<CalculationState> calculationState;
}
...
// The point that defines the minimum visiable of the view when in its closed
// state. You must set this before using the PullableView.
@property (readwrite,assign) CGPoint minVisiblePoint;

// The point that defines the maximum visiable of the view when in its opened
// state. You must set this before using the PullableView.
@property (readwrite,assign) CGPoint maxVisiblePoint;
